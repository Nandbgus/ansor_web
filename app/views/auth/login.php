    ...
    <div class="bg-white p-6 rounded-lg shadow-lg mt-8">
        ...
        <form action="<?= BASEURL ?>/auth/login" method="POST" class="space-y-4">
            <div>
                ...
                <input type="email" name="email" id="email_login" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <div>
