<div class="h-1/2 bg-gray-800 text-white w-3/4 md:w-1/4 absolute md:relative z-40 transform transition-transform duration-300 ease-in-out" :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen, 'md:translate-x-0': sidebarOpen || !sidebarOpen}">
